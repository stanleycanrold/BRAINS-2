...
import { EntryScreen } from "./new/EntryForm";
...
/**
 * B1 - Ideas portfolio (design system §4.1). Previously the dashboard; the
 * studio now owns /dashboard, so the per-idea pipeline portfolio lives here.
 *
...
export default async function IdeasPortfolioPage() {
...
function IdeaCard({
  ...
  return (
    ...
    >
      ...
      {/* Where it actually stands, in a sentence and a few numbers. */}
